  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        let newData:Fetch_RES<Single_Product[]> = await newRes.json();
        const relatedProducts = newData.data?.filter((e) => {
  ...
  return (
    <>
      {loading ? (
        ...
        >
          <Loader type="MoonLoader" size={40} />
        </Stack>
      ) : (
        <>
          {product && (
            <Container>
              ...
              >
                ...
                >
                  ...
                  <Divider
                    sx={{ marginY: "25px", bgcolor: "colors.darkgray" }}
                  />
